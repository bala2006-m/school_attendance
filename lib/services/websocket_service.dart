...
class WebSocketService {
  ...
  Future<void> connect() async {
    ...
    try {
      ...
      final baseUrl = HybridApiService.isHybridMode 
          ? await _getLocalBaseUrl() 
          : HybridApiService._effectiveBaseUrl;
  ...
  Future<String> _getLocalBaseUrl() async {
    ...
    if (HybridApiService.isLocalAvailable) {
      return HybridApiService._localBaseUrl!;
    }
    return HybridApiService._effectiveBaseUrl;
  }
  ...
  void initializeStreams() {
    ...
    _databaseChangeController = StreamController<Map<String, dynamic>>.broadcast();
  }
}
