...
import './build_rte_students_pdf.dart';

class RteStudentsReport extends StatefulWidget {
  const RteStudentsReport({
    super.key,
  ...
  @override
  State<RteStudentsReport> createState() => _RteStudentsReportState();
}

class _RteStudentsReportState extends State<RteStudentsReport> {
  bool isLoading = true;
  ...
  Future<void> init() async {
    final data = await RteApiServices.fetchRteStudentsSchool(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text(
                            'Do you want to generate the RTE Student List as a PDF For whole School?',
