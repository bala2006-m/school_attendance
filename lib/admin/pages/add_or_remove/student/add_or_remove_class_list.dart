...
import 'add_or_remove_student.dart';

class AddOrRemoveClassList extends StatefulWidget {
  const AddOrRemoveClassList({
    super.key,
  ...
  @override
  State<AddOrRemoveClassList> createState() => _AddOrRemoveClassListState();
}

class _AddOrRemoveClassListState extends State<AddOrRemoveClassList> {
  String? schoolName;
