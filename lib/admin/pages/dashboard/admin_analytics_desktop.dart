                ...
                children: [
                  ...
                  DataTable(
                    ...
                    rows: classComparisons.map((comp) => DataRow(cells: [
                          DataCell(Text(comp['class_name']?.toString() ?? 'Unknown')),
                          DataCell(Text('${comp['attendance_rate'] ?? 0}%')),
                          DataCell(Text('${comp['fee_rate'] ?? 0}%')),
                          DataCell(Text((comp['avg_marks'] ?? 0).toString())),
                        ])).toList(),
                  ),
                  const SizedBox(height: 40),
                  ...
                  DataTable(
                    ...
                    rows: predictiveInsights.take(20).map((insight) => DataRow(cells: [
                          DataCell(Text(insight['name']?.toString() ?? 'Unknown')),
                          DataCell(Text((insight['engagement_score'] ?? 0.0).toStringAsFixed(2))),
                        ])).toList(),
                  ),
                ],
              ),
