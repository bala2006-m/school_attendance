...
import 'exam_mark_report.dart';

class ExamMarkReportClasses extends StatefulWidget {
  const ExamMarkReportClasses({
    super.key,
  ...
  @override
  State<ExamMarkReportClasses> createState() => _ExamMarkReportClassesState();
}

class _ExamMarkReportClassesState extends State<ExamMarkReportClasses> {
  String? schoolName;
