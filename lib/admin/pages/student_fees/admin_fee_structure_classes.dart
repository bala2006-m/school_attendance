...
class AdminFeeStructureClasses extends StatefulWidget {
  const AdminFeeStructureClasses({
    super.key,
  ...
  @override
  State<AdminFeeStructureClasses> createState() =>
      _AdminFeeStructureClassesState();
}

class _AdminFeeStructureClassesState extends State<AdminFeeStructureClasses> {
  String? schoolName;
                ...
                : RefreshIndicator(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      // ClassFeeDashboard(data: allTermFees),
                      // const SizedBox(height: 16),
                      classes.isEmpty
                          ? const Center(
                            child: Text(
