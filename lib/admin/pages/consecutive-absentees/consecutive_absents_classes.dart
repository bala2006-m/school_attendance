...
import 'consecutive_absents.dart';

class ConsecutiveAbsentsClasses extends StatefulWidget {
  const ConsecutiveAbsentsClasses({
    super.key,
  ...
  @override
  State<ConsecutiveAbsentsClasses> createState() =>
      _ConsecutiveAbsentsClassesState();
}

class _ConsecutiveAbsentsClassesState extends State<ConsecutiveAbsentsClasses> {
  String? schoolName;
