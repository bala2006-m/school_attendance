...
class CollectFeesClasses extends StatefulWidget {
  const CollectFeesClasses({
    super.key,
  ...
  @override
  State<CollectFeesClasses> createState() => _CollectFeesClassesState();
}

class _CollectFeesClassesState extends State<CollectFeesClasses> {
  String? schoolName;
